...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public boolean isShowFirstLine() {
        return isShowFirstLine;
    }

    public void setShowFirstLine(boolean showFirstLine) {
        isShowFirstLine = showFirstLine;
    }
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        ...
        final int childCount = parent.getChildCount() - (isShowLastLine ? 0 : 1);//-1是为了loading那里去掉分割线
        for (int i = isShowFirstLine ? 0 : 1; i < childCount; i++) {//从1开始是不想画上面的那条分割线
