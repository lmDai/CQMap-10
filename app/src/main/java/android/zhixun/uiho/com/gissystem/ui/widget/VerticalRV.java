...
public class VerticalRV extends RecyclerView {

    public VerticalRV(Context context) {
        this(context,null);
    }

    public VerticalRV(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public VerticalRV(Context context, @Nullable AttributeSet attrs, int defStyle) {
