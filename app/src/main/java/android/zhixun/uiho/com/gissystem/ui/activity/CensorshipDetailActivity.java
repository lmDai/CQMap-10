...
public class CensorshipDetailActivity extends BaseActivityWithTitle {
    ...
    private void initViews() {
        ...
        arrowResultType.setOnClickListener(view -> {
...
//        tv_submitter.setText(crActiveUser.getNickname());
        ...
        //检查情况
        String JCone = "未选择", JCThree = "未选择", JCFour = "未选择", JCFive = "未选择",
                JCSix = "未选择", JCSeven = "未选择",
        ...
        if (mCompanyDetailByCheckedModel.getSecrecyInspectEntryCompanyList() != null &&
                !mCompanyDetailByCheckedModel.getSecrecyInspectEntryCompanyList().isEmpty()) {

            //检查情况和整改建议的所有id集合(size = 19)
            for (SecrecyInspectEntryCompanyListModel entryCompanyModel :
                    mCompanyDetailByCheckedModel.getSecrecyInspectEntryCompanyList()) {

//                List<SecrecyInspectEntryListModel> entryList = mCompanyDetailByCheckedModel.getSecrecyInspectEntryList();
//                if (entryList == null || entryList.isEmpty()) continue;

                if (entryCompanyModel.getSecrecyInspectEntryId() == 1) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        JCone = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        JCone = "否";
                    } else {
                        JCone = "未选择";
                    }
                }
                if (entryCompanyModel.getSecrecyInspectEntryId() == 3) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        JCThree = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        JCThree = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 4) {
                    if (entryCompanyModel.getIsPass() == 0) {
                        JCFour = "差";
                    } else if (entryCompanyModel.getIsPass() == 1) {
                        JCFour = "较差";
                    } else if (entryCompanyModel.getIsPass() == 2) {
                        JCFour = "一般";
                    } else if (entryCompanyModel.getIsPass() == 3) {
                        JCFour = "较好";
                    } else if (entryCompanyModel.getIsPass() == 4) {
                        JCFour = "好";
                    } else {
                        JCFour = "未选择";
                    }
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 5) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        JCFive = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        JCFive = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 6) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        JCSix = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        JCSix = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 7) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        JCSeven = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        JCSeven = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 8) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        JCEight = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        JCEight = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 9) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        JCNine = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        JCNine = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 10) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        JCTen = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        JCTen = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 11) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        JCelevn = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        JCelevn = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 12) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        JCtwelve = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        JCtwelve = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 13) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        JCthirteen = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        JCthirteen = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 14) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        JCfourteen = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        JCfourteen = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 15) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        JCfifteen = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        JCfifteen = "否";
                ...
                //16是其他问题。。。。
                //整改建议
                if (entryCompanyModel.getSecrecyInspectEntryId() == 17) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        ZGone = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        ZGone = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 18) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        ZGtwo = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        ZGtwo = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 19) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        ZGthree = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        ZGthree = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 20) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        ZGfour = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        ZGfour = "否";
                ...
                if (entryCompanyModel.getSecrecyInspectEntryId() == 21) {
                    if (entryCompanyModel.getIsPass() == 1) {
                        ZGfive = "是";
                    } else if (entryCompanyModel.getIsPass() == 0) {
                        ZGfive = "否";
...
//                }
        ...
        final List<CheckGroupModel> CheckGroupModelList = new ArrayList<>(16);
        ...
        CheckListModel six = new CheckListModel("（六）是否建立涉密成果管理平台", 1, JCSix);
        CheckListModel seven = new CheckListModel("（七）是否有专人管理涉密成果", 1, JCSeven);
        CheckListModel eight = new CheckListModel("（八）是否与涉密人员签订保密协议", 1, JCEight);
        CheckListModel nine = new CheckListModel("（九）是否存在涉密测绘成果擅自转让", 1, JCNine);
        CheckListModel ten = new CheckListModel("（十）移动存储介质管理是否符合要求", 1, JCTen);
        CheckListModel eleven = new CheckListModel("（十一）涉密计算机是否连入互联网", 1, JCEight);
        CheckListModel twelve = new CheckListModel("（十二）涉密计算机密码是否按要求设置为动态密码", 1, JCtwelve);
        CheckListModel thirteen = new CheckListModel("（十三）涉密计算机端口，串口是否符合保密规定", 1, JCthirteen);
        CheckListModel fourteen = new
                CheckListModel("（十四）销毁测绘地理信息成果是否按规定程序报批市规划局备案及到指定位置销毁", 1, JCfourteen);
        CheckListModel fiveteen = new CheckListModel("（十五）核心岗位涉密成员", 1, JCfifteen);
        ...
        censorshipDetailAdapter.setOnItemClickListener((view, position) -> {
            ...
            myDialog.getWindow().findViewById(R.id.img_browse_back).setOnClickListener(view1 -> myDialog.dismiss());
        });
    }

    private void addAchievement() {
        if (mCompanyDetailByCheckedModel.getSecrecyInspectFruitList() != null) {
            for (SecrecyInspectFruitListModel secrecyInspectFruitListModel :
                    mCompanyDetailByCheckedModel.getSecrecyInspectFruitList()) {
                View viewEdit = getLayoutInflater().inflate(R.layout.layout_jcxq_item, llResultType,
                        false);
            ...
            View viewDivider = getLayoutInflater().inflate(R.layout.layout_divider_view, llResultType,
                    false);
