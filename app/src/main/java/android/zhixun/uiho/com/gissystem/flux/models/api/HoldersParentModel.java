...
public class HoldersParentModel implements Parcelable,Parent<HoldersModel> {
    ...
    public HoldersParentModel() {
    }

    protected HoldersParentModel(Parcel in) {
        ...
        holdersModels = in.createTypedArrayList(HoldersModel.CREATOR);
    }

    public static final Creator<HoldersParentModel> CREATOR = new Creator<HoldersParentModel>() {
        @Override
        public HoldersParentModel createFromParcel(Parcel in) {
            return new HoldersParentModel(in);
        }

        @Override
        public HoldersParentModel[] newArray(int size) {
            return new HoldersParentModel[size];
        }
    };
    ...
    public ArrayList<HoldersModel> getHoldersModels() {
        return holdersModels;
    }

    public void setHoldersModels(ArrayList<HoldersModel> holdersModels) {
        this.holdersModels = holdersModels;
    }

    @Override
    public List<HoldersModel> getChildList() {
        return holdersModels;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeTypedList(holdersModels);
    }
}
