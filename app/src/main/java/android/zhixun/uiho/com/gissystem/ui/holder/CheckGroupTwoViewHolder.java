...
public class CheckGroupTwoViewHolder extends ParentViewHolder {
    ...
    public CheckGroupTwoViewHolder(@NonNull View itemView, OnExpandableItemCheckedListener onExpandableItemCheckedListener) {
        super(itemView);
