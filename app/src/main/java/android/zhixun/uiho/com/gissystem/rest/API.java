...
//     */
//    @POST(BASE_URL)
//    Observable<BaseResultModel<LoginModel>> login(@Field("username") String username, @Field("password") String password);
...
//     */
//    @POST(BASE_URL)
//    Observable<UserModel> register(@FieldMap Map<String, String> data);
//
//    @POST(BASE_URL)
//    Observable<BaseResultModel<UserModel>> login(@Field("data") String data);
//
//    @POST(BASE_URL)
//    Observable<BaseListResultModel<NewsModel>> getNewsList(@Field("data") String data);
//
//    @POST(BASE_URL)
//    Observable<BaseResultModel<CheckUpdateVersionModel>> checkUpdate(@Field("data") String data);
//
//    @POST(BASE_URL)
//    Observable<BaseListResultModel<MessageModel>> getMessageList(@Field("data") String data);
//
//    @POST(BASE_URL)
//    Observable<BaseListResultModel<MsgModel>> getMsgList(@Field("data") String data);
//
//    @POST(BASE_URL)
//    Observable<BaseListResultModel<PluginModel>> getPluginList(@Field("data") String data);
//
//    @POST(BASE_URL)
//    Observable<BaseResultModel<MapZipModel>> getMapUrl(@Field("data") String data);
//
...
//
//    @GET(URL_PREFIX)
//    Call<BaseResultModel<UpdateVersionModel>> checkUpdate(@Field("data") String data);
//
////    @GET(URL_PREFIX)
////    Call<BaseResultModel<UpdateVersionModel>> checkUpdate(@FieldMap Map<String, String> data);
//
//    @POST(URL_PREFIX)
//    Call<BaseResultModel<UpdateVersionModel>> checkUpdate(@Body Map<String,String> map);
//
//    @POST(URL_PREFIX)
//    Observable<BaseResultModel<UpdateVersionModel>> checkUpdateObservable(@Field("data") String data);
//
//    @POST(URL_PREFIX)
//    Observable<BaseListResultModel<UpdateVersionModel>> test(@Field("data") String data);
}
