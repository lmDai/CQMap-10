...
/**
 * Created by parcool on 2016/9/12.
 */
...
//            return JSON.parseObject(value.string(),new TypeReference<T>(){}.getType(),config,featureValues,features != null ? features : EMPTY_SERIALIZER_FEATURES);
